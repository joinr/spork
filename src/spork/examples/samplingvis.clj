;;Ported from an earlier visualization.  Still a little bit
;;janky. Need to fix some artifacts.  Ideally we can move this
;;over to the scenegraph backend using piccolo and have an
;;actual multitrack display example.  Still, somewhat
;;useful.
(ns spork.examples.samplingvis
  (:require [spork.sketch :refer :all]
            [spork.sketch.activity :refer [->track ->tracks with-event->color]]
