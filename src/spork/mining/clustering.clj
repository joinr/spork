...
;;rows are vectors...
(defn hcluster [rows & {:keys [distance] :or {distance pearson}}]
  (loop [distances {} ;cache of distance calcs
    ...
    (if (= (count clust) 1) clust
      ...
      (let [get-node          (fn [k] (nth clust k))
            ...
            cluster-idx-pairs (partition 2 1 (range clust))
        ...
        (recur dists (dec nextid) (subvec clust 2)))))) 
